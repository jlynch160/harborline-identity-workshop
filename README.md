...
The protected live-demo workspace includes the same six-step AI copilot in its companion rail. It follows the selected persona and moment while the administrator and user desktops remain visible, and provides direct launches to the private tenant agent, the relevant Microsoft control and the full AI story.
